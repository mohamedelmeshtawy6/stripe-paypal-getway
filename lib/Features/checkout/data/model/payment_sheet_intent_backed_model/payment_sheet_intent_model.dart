...
class PaymentSheetIntentBackedModel extends Equatable {
  final String? id;
  final String? object;
  final int? amount;
  ...
  const PaymentSheetIntentBackedModel({
    this.id,
    this.object,
    this.amount,
  ...
  factory PaymentSheetIntentBackedModel.fromJson(Map<String, dynamic> json) {
    return PaymentSheetIntentBackedModel(
